...
router.post('/users/task', (req, res) => {
    ...
    // o sea, modifico el [] tareas y lo cambio por un [] de obj,
    // reemplazando el nombre por un obj como el de arriba
